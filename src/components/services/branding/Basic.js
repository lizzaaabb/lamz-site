...
const TEXT = {
 ...
 ka: {
  ...
  price: '1100₾',
  priceNote: '+600₾ სრული ქართული ადაპტაცია',
  desc: 'ბიზნესისთვის შექმნილი საბაზისო ვიზუალური იდენტობა, რომელიც გაძლევთ პროფესიონალურ და ერთიან ონლაინ სახეს.',
  includesLabel: 'რას მოიცავს',
  includes: [
    'ლოგოს დიზაინი',
    'ბრენდის ფერთა პალიტრა',
    'შრიფტების სისტემა',
    'ლოგოს სხვადასხვა ვერსია',
    'საბაზისო ბრენდის სახელმძღვანელო (brand guidelines)',
    'ვიზუალური სტილი და მიმართულება',
    'ვებსაიტზე მორგებული ბრენდის იდენტობა',
    'რეკომენდაციები ონლაინ ვიზუალური სტილისთვის',
    'ერთიანი დიზაინის სისტემა ვებსაიტისა და კონტენტისთვის',
  ],
  note: 'ეს პაკეტი გაძლევთ მყარ ვიზუალურ საფუძველს, რომ თქვენი ბიზნესი თავიდანვე გამოიყურებოდეს პროფესიონალურად და სანდოდ.',
