...
const TEXT = {
  ...
  price: '1700₾',
  priceNote: '+800₾ ორენოვანი სისტემა',
  desc: 'სრული პროფესიონალური იდენტობის სისტემა ბიზნესებისთვის, რომლებსაც სურთ დახვეწილი, მასშტაბირებადი და ერთიანი ბრენდი ვებსაიტზე, სოციალურ მედიაში და მარკეტინგულ მასალებში.',

  includesLabel: 'მოიცავს საბაზისო ბრენდინგის ყველაფერს, დამატებით:',
  includes: [
    'სრული ბრენდის სახელმძღვანელო (Brand Guidelines)',
    'ლოგოს გამოყენების წესები',
    'ვებსაიტისა და ბეჭდური მასალების გამოყენების მაგალითები',
    'ტიპოგრაფიის იერარქია',
    'ფერების გამოყენების სისტემა',
    'ბრენდის ვიზუალური სტილის დეტალური აღწერა',
    'ფოტო და ვიზუალური მიმართულება',
    'მაგალითები — რა შეესაბამება და რა არ შეესაბამება ბრენდს',
    'განლაგებისა და spacing-ის პრინციპები',
    'მკაფიო სისტემა მომავალი დიზაინერებისა და დეველოპერებისთვის',
  ],

  note: 'იდეალურია ბიზნესებისთვის, რომლებიც ქმნიან ძლიერ ონლაინ იმიჯს და გრძელვადიანი ერთიანი ბრენდის იდენტობას.',
  optionalLabel: 'დამატებითი სერვისი',
  optional: [
