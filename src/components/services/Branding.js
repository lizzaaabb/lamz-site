...
const corp1 = '/branding/b1.png'
const corp2 = '/branding/b2.png'
const corp3 = '/branding/b3.png'
const shop1 = '/branding/l1.PNG'
const shop2 = '/branding/l2.PNG'
const shop3 = '/branding/l3.PNG'
const estate1 = '/branding/full1.PNG'
const estate2 = '/branding/full2.PNG'
const estate3 = '/branding/full3.PNG'
